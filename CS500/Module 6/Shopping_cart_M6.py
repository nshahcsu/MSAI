...
while (item_count< MAX_ITEM):
    ...
    if user_input == 'a':
        ...
        try:
            ...
            temp_item.description = input('Enter Description:\n')
        ...
        rm_item = input('Please Enter Item Name to Remove.')
        shopping_cart.remove_item(rm_item)
    elif user_input == 'c':
        temp_item = ItemToPurchase()
        # assign user input value via attribute assignment
        try:
            temp_item.item_name = input('Enter Item Name to update: \n')
            temp_item.description = input('Enter Description to update: \n')
            temp_item.item_price = float(input('Enter Item Price to update: \n'))
            temp_item.item_quantity = int(input('Enter Item Quantity to update: \n')) 
        except:
            print('Invalid Input.')
