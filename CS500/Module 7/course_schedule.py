...
while (fail_count < MAX_FAIL_COUNT):
    try:
        course_cd = input('Please enter a Course Number to view schedule.\n').upper()
        avail_courses = ''
        if course_cd in (dict_room_number and dict_instructors and dict_meeting):     
            ...
            print('\n\nInformation for the course:',course_cd)
            ...
            if ( fail_count == MAX_FAIL_COUNT):
                ...
                print("Course info not available for the course number you entered.\nCurrently, Schedule is available for these courses:")
